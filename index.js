...
ipcMain.on('openMSALoginWindow', (ipcEvent, args) => {
    ...
    MSALoginWindow.loadURL('https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?client_id=82e0d93e-9e65-4adf-93ce-a9e6eabdf11b&response_type=code&scope=XboxLive.signin%20offline_access&redirect_uri=https://login.microsoftonline.com/common/oauth2/nativeclient')
})
